...
public class LogginSecondPageParrot {
    ...
    public void LogginToParrotplay1() throws Exception {
        driver.get("http://52.58.156.11:3000/#/login");
        ...
        driver.get("http://52.58.156.11:3000/#/remote");
        WebDriverWait wait3 = new WebDriverWait(driver, 10);
        wait3.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/app/remote/div/main/div/div/div[1]/div")));
    }
}
